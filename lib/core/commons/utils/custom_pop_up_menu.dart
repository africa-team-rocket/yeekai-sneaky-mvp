...
/// To show a popup menu, use the [showBlurryMenu] function. To create a button that
...
/// [PopupBlurryMenuItem]), or no value at all (for example, [PopupMenuDivider]).
///
/// See also:
///
///  * [PopupBlurryMenuItem], a popup menu entry for a single value.
///  * [PopupMenuDivider], a popup menu entry that is just a horizontal line.
///  * [CheckedPopupMenuItem], a popup menu item with a checkmark.
///  * [showBlurryMenu], a method to dynamically show a popup menu at a given location.
...
abstract class PopupMenuEntry<T> extends StatefulWidget {
  ...
  ///
  /// This value is used at the time the [showBlurryMenu] method is called, if the
  ...
  ///
  /// This method is used by [showBlurryMenu], when it is called, to align the entry
...
/// See also:
///
///  * [PopupBlurryMenuItem], for the kinds of items that this widget divides.
///  * [showBlurryMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
...
///
/// Typically the [child] of a [PopupBlurryMenuItem] is a [Text] widget. More
/// elaborate menus with icons can use a [ListTile]. By default, a
/// [PopupBlurryMenuItem] is [kMinInteractiveDimension] pixels high. If you use a widget
...
/// keep the text of [PopupBlurryMenuItem]s that use [Text] widgets in their [child]
/// slot aligned with the text of [CheckedPopupMenuItem]s or of [PopupBlurryMenuItem]
/// that use a [ListTile] in their [child] slot.
///
/// See also:
///
///  * [PopupMenuDivider], which can be used to divide items from each other.
///  * [CheckedPopupMenuItem], a variant of [PopupBlurryMenuItem] with a checkmark.
///  * [showBlurryMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
class PopupBlurryMenuItem<T> extends PopupMenuEntry<T> {
  /// Creates an item for a popup menu.
  ///
  /// By default, the item is [enabled].
  ///
  /// The `enabled` and `height` arguments must not be null.
  const PopupBlurryMenuItem({
    super.key,
    this.value,
    this.onTap,
    this.enabled = true,
  ...
  /// The value that will be returned by [showBlurryMenu] if this entry is selected.
  final T? value;
  ...
  @override
  PopupMenuItemState<T, PopupBlurryMenuItem<T>> createState() => PopupMenuItemState<T, PopupBlurryMenuItem<T>>();
}

/// The [State] for [PopupBlurryMenuItem] subclasses.
///
/// By default this implements the basic styling and layout of Material Design
/// popup menu items.
///
/// The [buildChild] method can be overridden to adjust exactly what gets placed
/// in the menu. By default it returns [PopupBlurryMenuItem.child].
///
/// The [handleTap] method can be overridden to adjust exactly what happens when
/// the item is tapped. By default, it uses [Navigator.pop] to return the
/// [PopupBlurryMenuItem.value] from the menu route.
///
/// This class takes two type arguments. The second, `W`, is the exact type of
/// the [Widget] that is using this [State]. It must be a subclass of
/// [PopupBlurryMenuItem]. The first, `T`, must match the type argument of that widget
/// class, and is the type of values returned from this menu.
class PopupMenuItemState<T, W extends PopupBlurryMenuItem<T>> extends State<W> {
  /// The menu item contents.
  ///
  /// Used by the [build] method.
  ///
  /// By default, this returns [PopupBlurryMenuItem.child]. Override this to put
  ...
  ///
  /// By default, uses [Navigator.pop] to return the [PopupBlurryMenuItem.value] from
  /// the menu route.
  @protected
  void handleTap() {
...
/// matches the default minimum height of a [PopupBlurryMenuItem]. The horizontal
...
/// See also:
///
///  * [PopupBlurryMenuItem], a popup menu entry for picking a command (as opposed to
///    toggling a value).
///  * [PopupMenuDivider], a popup menu entry that is just a horizontal line.
///  * [showBlurryMenu], a method to dynamically show a popup menu at a given location.
///  * [PopupMenuButton], an [IconButton] that automatically shows a menu when
///    it is tapped.
class CheckedPopupMenuItem<T> extends PopupBlurryMenuItem<T> {
...
/// argument is the value of the [PopupBlurryMenuItem] that caused its menu to be
/// dismissed.
///
...
class _PopupMenuDefaultsM2 extends PopupMenuThemeData {
  ...
  @override
  TextStyle? get textStyle => _textTheme.labelMedium;
}
