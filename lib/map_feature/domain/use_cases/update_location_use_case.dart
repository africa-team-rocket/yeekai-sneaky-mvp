...
class UpdateUserLocationUseCase {
  ...
  void startLocationUpdates() async {
    // try {
      ...
      _locationStreamController.sink.add(
        Resource.success(UserLocationData(position: initialPosition, bearing: 0.0),
        ));
  ...
  Stream<Resource<UserLocationData>> execute() {
    ...
    return _locationStreamController.stream.onErrorReturnWith((error, stackTrace) => Resource.error('An error occurred : $error'));
  ;
  }
}
